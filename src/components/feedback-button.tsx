  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-4 right-4 z-50 flex items-center gap-1.5 rounded-full bg-amber-700 px-4 py-2.5 text-white shadow-lg ring-1 ring-amber-800/30 transition-all hover:bg-amber-800 hover:scale-105 hover:shadow-xl print:hidden"
