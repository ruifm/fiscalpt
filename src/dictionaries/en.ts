...
const en: DictShape<PtDict> = {
  ...
  simulation: {
    ...
    subtitle: 'Estimate your IRS in under 2 minutes',
    filingStatus: 'Filing Status',
    single: 'Single',
    married: 'Married',
    taxYear: 'Tax Year',
    income: 'Income',
    personLabel: 'Taxpayer {letter}',
    singleLabel: 'Taxpayer',
    birthYear: 'Birth year',
    grossCatA: 'Cat A (employment)',
    grossCatAHelp: 'Gross annual employment income (before taxes)',
    grossCatB: 'Cat B (self-employment)',
    ...
    dependentsOver6: 'Children > 6 years',
    calculate: 'Calculate',
    calculating: 'Calculating...',
    resultsTitle: 'Tax Simulation',
    disclaimer:
      '* Estimated values based on standard assumptions. For accurate results, use the Personalized Analysis with your tax documents.',
    fullAnalysisCta: 'More accurate results',
    fullAnalysisDesc:
      'Upload your AT documents for a detailed analysis with actual withholding values, deductions, and year-over-year comparison.',
    ...
    teaserOptimization: '{count} optimization identified',
    teaserOptimizations: '{count} optimizations identified',
    teaserSavingsPrefix: 'Save up to',
    teaserSavingsSuffix: 'with personalized analysis',
    teaserCta: 'Analyze now',
