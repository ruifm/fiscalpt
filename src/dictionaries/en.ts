...
const en: DictShape<PtDict> = {
  ...
  simulation: {
    ...
    birthYear: 'Birth year',
    grossCatA: 'Gross annual income (Cat A)',
    grossCatAHelp: 'Gross employment income (before taxes)',
    hasCatB: 'Self-employment income?',
    grossCatB: 'Gross Cat B income',
    grossCatBHelp: 'Gross self-employment income (recibos verdes)',
